...
const ProductSalesPage = () => {
  ...
  const { data: listProductSales } = useQuery({
    queryKey: [pageNumber, "listProductSales"],
    queryFn: () => {
  ...
  return (
    <div className="p-8">
      {listProductSales && listProductSales?.totalElements > 0 ? (
        <>
        ...
        <p className="flex justify-center items-center text-3xl font-medium mb-8 h-56">
